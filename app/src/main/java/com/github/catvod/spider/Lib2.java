...
public class Lib extends Spider {
    ...
    public void init(Context context) {
        super.init(context);
        try {
            playerConfig = new JSONObject("{\"ali\":{\"sh\":\"AI播放\",\"pu\":\"https://sh-data-s01.chinaeast2.cloudapp.chinacloudapi.cn/ai.php?url=\",\"sn\":1,\"or\":999},\"LINE405\":{\"sh\":\"HD播放\",\"pu\":\"https://sh-data-s02.chinaeast2.cloudapp.chinacloudapi.cn/lb.php?url=\",\"sn\":1,\"or\":999},\"LINE406\":{\"sh\":\"LINE406\",\"pu\":\"https://sh-data-s01.chinaeast2.cloudapp.chinacloudapi.cn/zm.php?url=\",\"sn\":1,\"or\":999},\"duoduozy\":{\"sh\":\"LINE100\",\"pu\":\"https://play.shtpin.com/xplay/?url=\",\"sn\":1,\"or\":999},\"LINE407\":{\"sh\":\"LINE407\",\"pu\":\"https://sh-data-s01.chinaeast2.cloudapp.chinacloudapi.cn/lb.php?url=\",\"sn\":1,\"or\":999},\"LINE408\":{\"sh\":\"LINE408\",\"pu\":\"\",\"sn\":0,\"or\":999},\"p300\":{\"sh\":\"LINE300\",\"pu\":\"\",\"sn\":0,\"or\":999},\"p301\":{\"sh\":\"LINE301\",\"pu\":\"\",\"sn\":0,\"or\":999},\"line402-日语\":{\"sh\":\"LINE402\",\"pu\":\"\",\"sn\":0,\"or\":999},\"LINE400\":{\"sh\":\"LINE400\",\"pu\":\"https://sh-data-s01.chinaeast2.cloudapp.chinacloudapi.cn/lb.php?url=\",\"sn\":1,\"or\":999},\"line401\":{\"sh\":\"LINE401\",\"pu\":\"\",\"sn\":0,\"or\":999}}");
                ...
                if (scContent.startsWith("var player_")) { // 取直链
                    ...
                    if (playerConfig.has(player.getString("from"))) {
                        ...
                        if (player.getString("from").contains("LINE")) {
                            ...
                            result.put("playUrl", "");
                            result.put("url", url);
                            //   result.put("header", "{\"Referer\", \"https://www.libvio.fun/\"}");
                            return result.toString();
                        }
                        break;
                    }
